...
// Drop the image tool (roadmaps stay vector-only; keeps synced blobs small). Stable object.
...
export function ExcalidrawBoard() {
    ...
    return (
        <div className="absolute inset-0 z-10">
            <Excalidraw theme="light" initialData={INITIAL_DATA} UIOptions={UI_OPTIONS} />
        </div>
    )
}
